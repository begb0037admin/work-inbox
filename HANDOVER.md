...
- **Scheduled runs silently missing (2026-06-11):** 7am, 3pm and 5pm slots did not push a briefing; 9am/11am/1pm worked. Likely machine asleep/locked at those times. Check Task Scheduler → WorkInbox-Briefing → History/Last Run Result; enable "Wake the computer to run this task" on the Conditions tab.
