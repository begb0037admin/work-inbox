...
## AG FlexPoints — see its own handover
AG FlexPoints project handover lives in `ag-flexpoints/HANDOVER.md`
(synced to the AG-FlexPoints repo). Summary: dashboard/PDF/CSV all shipped
(PRs #4-#12); one open issue - portal login selectors (Kevin to send
`source/_login_debug.png` or use the Ctrl+S saved-page fallback); points
expiry deadline 2026-06-29.
