# Handover -- 9 September 2026, ~late evening (Drew) -- R. Mail-connector cutover BUILT, TESTED, and LIVE. `MAIL_BACKEND=connector` is now the scheduled task's registered default. Full detail below.
