...
function _priRenderOneCard(p,sec){
  ...
  const ccButton=p.id?`<button type="button" class="card-icon" title="Open in Command Centre" aria-label="Open in Command Centre" onclick="window.open('https://cc.lelitte.co.uk/#${p.id}','wi-cc-task-view');event.stopPropagation()">CC&#8594;</button>`:`<span class="card-icon card-icon-placeholder" aria-hidden="true"></span>`;
